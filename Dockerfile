...
# Create the SeCuReDmE_env conda environment
RUN conda env create --file environment.yml --name SeCuReDmE_env

# Activate the SeCuReDmE_env conda environment
RUN echo "source activate SeCuReDmE_env" > ~/.bashrc
